...
function CategoryPagination({products, getProducts}:{products:any, getProducts:(page:any)=>void}) {
  ...
  return (
    <div className="px-2 py-6 flex flex-col justify-center gap-4 ml:flex ml:flex-row ml:items-center ml:justify-between">
